...
/*   Updated: 2020/02/24 16:18:35 by swartz      ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
gnl_list	*lst_new(int fd, char *file)
{
	gnl_list *new;

	if (!(new = malloc(sizeof(gnl_list))))
		return (NULL);
	if (!file)
	{
...
gnl_list	*fd_check(gnl_list **str, int fd)
{
	gnl_list	*c_lst;
...
int		del_clst(gnl_list **file, gnl_list *clst)
{
	gnl_list *temp;
	gnl_list *temp_prec;
