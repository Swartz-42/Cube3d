...
/*   Updated: 2020/02/25 01:22:19 by swartz      ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static void	ft_display_pos_int(int val, int argsize, printf_tab *tpf)
{
	if (tpf->fminus == TRUE)
	{
...
static void	ft_display_neg_int(int val, int argsize, printf_tab *tpf)
{
	if (tpf->fminus == TRUE)
	{
		if (tpf->fprecision == TRUE)
